...
namespace Utils
{
  ...
  {
    public static void Throws<T>(Action task, string expectedMessage, ExceptionMessageCompareOptions options)
      where T : Exception
    {
      try
      {
    ...
    public static void Throws<T>(this IAssertion assertion, Action task, string expectedMessage,
                                 ExceptionMessageCompareOptions options) where T : Exception
    {
    ...
    public static void Throws(this IAssertion assertion, Action task, string expectedMessage,
                              ExceptionMessageCompareOptions options)
    {

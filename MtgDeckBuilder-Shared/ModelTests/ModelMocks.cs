...
namespace ModelTests.ModelMocks
{
	public class ManaCostModelMocks
	{
		/// <summary>
		/// {2/W}{2/U}{2/B}{2/R}{2/G}
		/// </summary>
		...
		/// {2/W}{2/U}{2/B}{2/R}{2/G}
		/// </summary>
		public static ManaCostModel ComplicatedResult2
		{
			get
			{
				var model = new ManaCostModel();
				model.Costs.Add(ManaColors.Colorless | ManaColors.White, 1);
				model.Costs.Add(ManaColors.Colorless | ManaColors.Blue, 1);
				model.Costs.Add(ManaColors.Colorless | ManaColors.Black, 1);
				model.Costs.Add(ManaColors.Colorless | ManaColors.Red, 1);
				model.Costs.Add(ManaColors.Colorless | ManaColors.Green, 1);
		...
		/// 3{B/G}{B/G}
		/// </summary>
		public static ManaCostModel ComplicatedResult
		{
			get
			{
				var model = new ManaCostModel();
				model.Costs.Add(ManaColors.Colorless, 3);
				model.Costs.Add(ManaColors.Black | ManaColors.Green, 2);
				return model;
			}
		}
		...
		/// 1W
		/// </summary>
		public static ManaCostModel SimpleResult
		{
			get
			{
				var model = new ManaCostModel();
				model.Costs.Add(ManaColors.Colorless, 1);
				model.Costs.Add(ManaColors.White, 1);
				return model;
			}
		}

		public static TCard GetCardValue<TCard>(string json)
		{
